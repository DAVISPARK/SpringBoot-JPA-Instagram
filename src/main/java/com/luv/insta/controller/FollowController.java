...
import com.luv.insta.model.Follow;
...
public class FollowController {
	...
	public @ResponseBody String follow(@AuthenticationPrincipal MyUserDetails userDetails, @PathVariable int id) {
	...
	public String followFollower(
		...
		// 팔로우 리스트 (cos : 1) 2, 3
		List<Follow> principalFollows = mFollowRepository.findByFromUserId(userDetails.getUser().getId());
	...
	public String followFollow(@PathVariable int id, @AuthenticationPrincipal MyUserDetails userDetails, Model model) {
