			...
			<div class="profile__info">
				<div class="profile__title">
					...
					<c:if test="${principal.user.id eq user.id}">
						<a href="/image/upload">
							<button class="profile_follow_btn">upload</button>
						</a> 
				...
				<ul class="profile__stats">
					...
					<li class="profile__stat"><span class="profile__stat-number">4,444 </span>
					<a href="/follow/follower/${user.id}">팔로워</a></li>
					<li class="profile__stat"><span class="profile__stat-number">44 </span>
					<a	 href="/follow/follow/${user.id}">팔로우</a></li>
				</ul>
